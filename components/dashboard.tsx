        ...
        <div className=" p-8 rounded-lg shadow-lg">
          ...
          <ul className="space-y-4">
            <div className="p-8 rounded-lg shadow-lg">
              ...
              <ul className="space-y-4">
                {/* Basic Information */}
                <li className="text-lg text-indigo-200 flex flex-col sm:flex-row justify-between items-start sm:items-center bg-indigo-900/50 rounded-lg px-4 py-3 shadow-md">
                ...
                <li className="text-lg text-indigo-200 flex flex-col sm:flex-row justify-between items-start sm:items-center bg-indigo-900/50 rounded-lg px-4 py-3 shadow-md">
                  ...
                  <span className="mt-1 sm:mt-0 sm:ml-4 text-indigo-100">
                    {formatTokens(userInfo.entryAmount)} $
                  </span>
                </li>
                <li className="text-lg text-indigo-200 flex flex-col sm:flex-row justify-between items-start sm:items-center bg-indigo-900/50 rounded-lg px-4 py-3 shadow-md">
                  <span className="font-semibold text-indigo-300">
                ...
                <li className="text-lg text-indigo-200 flex flex-col sm:flex-row justify-between items-start sm:items-center bg-indigo-900/50 rounded-lg px-4 py-3 shadow-md">
                  ...
                  <span className="mt-1 sm:mt-0 sm:ml-4 text-indigo-100">
                    {formatTokens(userInfo.totalReward)} $
                  </span>
                </li>
                ...
                <li className="text-lg text-indigo-200 flex flex-col sm:flex-row justify-between items-start sm:items-center bg-indigo-900/50 rounded-lg px-4 py-3 shadow-md">
                  ...
                  <span className="mt-1 sm:mt-0 sm:ml-4 text-indigo-100">
                    {formatTokens(userInfo.rightReward)} $
                  </span>
                </li>
                <li className="text-lg text-indigo-200 flex flex-col sm:flex-row justify-between items-start sm:items-center bg-indigo-900/50 rounded-lg px-4 py-3 shadow-md">
                  <span className="font-semibold text-indigo-300">
                ...
                <li className="text-lg text-indigo-200 flex flex-col sm:flex-row justify-between items-start sm:items-center bg-indigo-900/50 rounded-lg px-4 py-3 shadow-md">
                  ...
                  <span className="mt-1 sm:mt-0 sm:ml-4 text-indigo-100">
                    {formatTokens(userInfo.middleReward)} $
                  </span>
                </li>
                <li className="text-lg text-indigo-200 flex flex-col sm:flex-row justify-between items-start sm:items-center bg-indigo-900/50 rounded-lg px-4 py-3 shadow-md">
                  <span className="font-semibold text-indigo-300">
                ...
                <li className="text-lg text-indigo-200 flex flex-col sm:flex-row justify-between items-start sm:items-center bg-indigo-900/50 rounded-lg px-4 py-3 shadow-md">
                  ...
                  <span className="mt-1 sm:mt-0 sm:ml-4 text-indigo-100">
                    {formatTokens(userInfo.leftReward)} $
                  </span>
                </li>
              </ul>
            </div>
